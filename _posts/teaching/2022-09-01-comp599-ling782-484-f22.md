...
| 4 | Sep 13 (add or drop) | Word embeddings (cont..), Language Modeling |  | [Man is to Computer Programmer as Woman is to Homemaker? Debiasing Word Embeddings](https://arxiv.org/abs/1607.06520) |
| 5 | Sep 15 | CNN, RNN, LSTMs |  |  |
